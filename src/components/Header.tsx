        ...
        <div className="flex items-center py-4 gap-4">
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className="flex-shrink-0 w-80">
                <div className="flex items-center bg-white rounded-lg overflow-hidden">
                  <input
                    ...
                    className="flex-1 px-3 py-2 text-[16px] leading-[25.6px] text-[#0F1111] focus:outline-none header-text"
                  />
                  <button className="text-white px-4 py-2 flex items-center justify-center transition-colors" style={{ backgroundColor: '#febd69' }}>
              ...
              <div className="flex items-center gap-5 flex-shrink-0">
                <Link 
                  href="/" 
                  className="relative px-3 py-1.5 text-white text-[16px] leading-[25.6px] hover:text-white transition-colors font-medium group"
                >
                  <span className="relative z-10">Home</span>
                  <div className="absolute inset-0 border-2 border-transparent group-hover:border-white transition-all duration-200 pointer-events-none"></div>
                </Link>
                <Link 
                  href="/products" 
                  className="relative px-3 py-1.5 text-white text-[16px] leading-[25.6px] hover:text-white transition-colors font-medium group"
              ...
              <div className="flex items-center gap-5 flex-shrink-0 ml-auto">
                <Link href="/cart" className="flex items-center gap-2 text-white hover:text-gray-200 transition-colors">
                  ...
                  <span className="text-[16px] leading-[25.6px] header-text font-normal">Cart</span>
                </Link>

                <button 
                  onClick={() => signOut({ callbackUrl: '/' })}
                  className="flex items-center gap-2 px-3 py-1.5 rounded-md transition-colors border border-transparent hover:border-white"
                >
                  <span className="text-[16px] leading-[25.6px] font-normal text-white">Logout</span>
                </button>
              </div>
            </>
          ) : (
            // Not logged-in state (only shown when we're sure user is not logged in)
            <div className="flex items-center gap-3 ml-auto">
              <Link 
                href="/login" 
                className="flex items-center gap-2 px-3 py-1.5 rounded-md transition-colors border border-transparent hover:border-white text-white"
              >
                <div className="relative">
                  <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512" className="w-3 h-5" xmlns="http://www.w3.org/2000/svg">
                    <path d="M224 256c70.7 0 128-57.3 128-128S294.7 0 224 0 96 57.3 96 128s57.3 128 128 128zm89.6 32h-16.7c-22.2 10.2-46.9 16-72.9 16s-50.6-5.8-72.9-16h-16.7C60.2 288 0 348.2 0 422.4V464c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48v-41.6c0-74.2-60.2-134.4-134.4-134.4z"></path>
                  </svg>
                </div>
                <span className="text-[16px] leading-[25.6px] header-text font-normal">Login</span>
              </Link>
              <Link 
                href="/register" 
                className="flex items-center gap-2 px-4 py-1.5 rounded-md transition-colors border border-transparent hover:border-white"
                style={{ backgroundColor: '#f90' }}
              >
                <span className="text-[16px] leading-[25.6px] font-medium text-white">Register</span>
              </Link>
            </div>
          )}
          ...
          <div className="flex items-center gap-3 ms-3">
            <a 
              target="_blank" 
              rel="noreferrer" 
              href="https://fb.com/samehsalehelkhayat"
            ...
            <a 
              target="_blank" 
              rel="noreferrer" 
              href="https://www.instagram.com/samehsalehelkhayat/"
              className="text-white hover:text-gray-200 transition-colors"
            >
            ...
            <a 
              target="_blank" 
              rel="noreferrer" 
              href="https://github.com/samehsalehelkhayat"
              className="text-white hover:text-gray-200 transition-colors"
            >
            ...
            <a 
              target="_blank" 
              rel="noreferrer" 
              href="https://www.linkedin.com/in/sameh-saleh-elkhayat/"
              className="text-white hover:text-gray-200 transition-colors"
            >
